...
export function RouteAuditTable({ routeDetails, search, setSearch, onRecalculate, onAddInternalRoute }: RouteAuditTableProps) {
            ...
            <div className="min-w-[1600px]">
              <table className="w-full border-collapse">
                ...
                <tbody className="divide-y divide-slate-100">
                  {filtered.length === 0 ? (
                    <tr>
                      <td colSpan={9} className="px-8 py-20 text-center text-slate-400 font-bold uppercase text-[10px]">No route records found</td>
                    </tr>
                  ) : filtered.map(row => (
